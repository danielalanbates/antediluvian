...
| 02 | CHUNK_02_combat_events.md | Server combat events → remote attack/hit/death anims | todo |
| 03 | CHUNK_03_terrain.md | Per-act heightmap terrain, ground texture, water | todo |
| 04 | CHUNK_04_environment.md | Real trees/rocks, inn building, per-act prop sets | todo |
